...
class EquipmentController extends Controller
{
    ...
    public function allClaim($claim_id){
        $equipment=Equipment::select()->where([['ClaimOrIncident', "Claim"],['claim_id', $claim_id]])->with("typeOfEquipment")
        ->with("brand")
        ->with("natureOfDamage")
        ->with("department")
        ->get();
    ...
    public function allIncident($claim_id){
        $equipments=Equipment::select()->where([['ClaimOrIncident', "Incident"],['claim_id', $claim_id]])->with("typeOfEquipment")
        ->with("brand")
        ->with("natureOfDamage")
        ->with("department")
        ->get();
