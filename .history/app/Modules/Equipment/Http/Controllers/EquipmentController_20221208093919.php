...
class EquipmentController extends Controller
{
    ...
    public function allIncident(){
        ...
        //->with("estimate")
        ->get();
        dd($equipment[0]->type_of_equipment);
        if($equipment->brand==null){
            $equipment->brand = ["id" => 0, "name" => ""];
        }
        if($equipment->nature_of_damage==null){
            $equipment->nature_of_damage = ["id" => 0, "name" => ""];
        }
        if($equipment->type_of_equipment==null){
            $equipment->type_of_equipment = ["id" => 0, "name" => ""];
        }
            return [
                "payload" => $equipment,
                "status" => "200_1"
